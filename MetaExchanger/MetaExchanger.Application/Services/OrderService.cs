...
namespace MetaExchanger.Application.Services
{
    ...
    public class OrderService : IOrderService
    {
        ...
        public async Task<Result> ProcessAsBuy(DomainOrder requestDomainOrder, List<DomainOrder> responseResult)
        {
        ...
        public async Task<Result> ProcessAsSell(DomainOrder domainOrder, List<DomainOrder> responseResult)
        {
